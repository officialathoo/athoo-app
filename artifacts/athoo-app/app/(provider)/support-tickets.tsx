  ...
  return (
    <View style={[styles.container, { paddingTop: topPad }]}>
      <View style={styles.header}>
        ...
        <Pressable style={styles.newBtn} onPress={() => router.push("/(provider)/contact-support" as any)}>
      ...
      {loading ? (
        ...
        <View style={styles.center}>
          ...
          <Pressable style={styles.ctaBtn} onPress={() => router.push("/(provider)/contact-support" as any)}>
